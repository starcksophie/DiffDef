""" Training script for the autoencoder with KL regulization. from https://github.com/Warvito/generative_brain.git"""
import argparse
import warnings
...
from training_functions_aekl import train_aekl
...
def parse_args():
    ...
    parser.add_argument("--eval_freq", type=int, default=1, help="Number of epochs to between evaluations.")
    parser.add_argument("--num_workers", type=int, default=8, help="Number of loader workers")
    parser.add_argument("--experiment", default="aekl_v0_mlflow", help="Mlflow experiment name.")
...
def main(args):
    ...
    output_dir = Path(args.run_dir+"runs/")
    ...
    train_loader, val_loader = setup_dataset(args.training_ids, args.validation_ids, args.batch_size, context=False)
